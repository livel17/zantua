    ...
    <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="d-flex">
                            <div class="p-2">
                                <a href="archive_user.php" class="btn btn-icon-split btn-danger">
                                    <span class="icon text-white-50">
                                        <i class="fas fa-folder"></i>
                                    </span>
                                    <span class="text text-white">Archive</span>
                                </a>
                            </div>
                            <div class="p-2">
                                <a href="register.php" class="btn btn-icon-split"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        <?php
                                        $stmt = $conn->query("SELECT * FROM admin WHERE role='Manager' ");
                                        while ($res = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class='btn btn-info viewbtn' data-toggle='modal'
                                                            data-target="#viewModal_<?php echo $res["user_Id"]; ?>">
                                                            <i class='fas fa-fw fa-eye'>
                                                            </i>
                                                        </button>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger conf" data-toggle="modal"
                                                            data-target="#archiveModal">
                                                            <i class='fas fa-fw fa-archive'></i></button>
                                                    </td>
                                                </tr>

                                                <!-- View Modal -->
                                                <div class="modal fade" id="viewModal_<?php echo $res["user_Id"]; ?>"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="viewModalLabel_<?php echo $res["user_Id"]; ?>"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="viewModalLabel_<?php echo $res["user_Id"]; ?>">View User
                                                                    Information</h5>
                                                ...
                                                <div class="modal fade" id="archiveModal"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form method="post" action="../php/archive.php">
