    ...
    <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="d-flex">
                            <div class="p-2">
                                <a href="profile.php" class="btn btn-icon-split"
                                    style="background-color: gray; float: right;">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        <?php
                                        $stmt = $conn->query("SELECT * FROM admin WHERE role='Unknown'");
                                        while ($res = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../php/archive.php?user_id=<?php echo $id; ?>"><button type="button" class="btn btn-primary conf">
                                                            <i class='fas fa-fw fa-arrow-alt-circle-up'></i></button></a>
                                                    </td>
                                                </tr>
