...
<body id="page-top">
  ...
  <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Settings</h1><br>
        <a href="settings.php" class="btn btn-dark btn-icon-split">
    ...
    <div class="row" style="justify-content: center;">
        ...
        style="max-width: 480px; height: auto; margin-left: 10px;"
        action="../php/changepass.php"
        method="POST">
        ...
        <?php } ?>
        <div class="card mb-1" style="max-width: 480px; height: 420px; text-align: left;">
        ...
        <div>
            <input  type="hidden"
            name="userid"
            value="<?php echo (isset($_GET['userid']))?$_GET['userid']:"$id" ?>"
            class="form-control">
            <div class="form-group row" style="margin: 10px;">
                <div class="col-sm-12">
                    ...
                    class="form-control"
                    name="oldpass"
                    value="<?php echo (isset($_GET['oldpass']))?$_GET['oldpass']:"" ?>">
                </div>
                <div class="col-sm-12">
                    <br>
                    ...
                    class="form-control"
                    name="newpass"
                    value="<?php echo (isset($_GET['newpass']))?$_GET['newpass']:"" ?>">
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    class="form-control"
                    name="newc_pass"
                    value="<?php echo (isset($_GET['newc_pass']))?$_GET['newc_pass']:"" ?>">
                </div>
                <div class="col-sm-6">
                    <br>
                </div>
            ...
            <div class="form-group row text-center">
                ...
                <div class="col-sm-6">
                    <button type="submit" 
                    name="change"
                    class="btn btn-icon-split" style="background-color: #40916C;">
                    <span class="icon text-white-50">
